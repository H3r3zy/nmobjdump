...
READELFSRC	=	src/file.c	\
			...
			src/readelf/dump/header/file.c \
			src/readelf/dump/header/program.c \
			src/readelf/dump/header/sections.c	\
			src/readelf/dump/notes.c	\
			src/readelf/dump/rela.c	\
			src/readelf/dump/symbol.c
